...
* [2. The Basics of OCaml](basics/intro.md)
  ...
  - [2.3. Functions](basics/function_definitions.md)
...
* [3. Data in OCaml](data/intro.md)
  - [3.1. Lists](data/lists.md)
    + [3.1.1. Building Lists](data/building_lists.md)
    + [3.1.2. Accessing Lists](data/accessing_lists.md)
    + [3.1.3. Mutating Lists](data/mutating_lists.md)
    + [3.1.4. Pattern Matching with Lists](data/pattern_matching_lists.md)
    + [3.1.5. Tail Recursion](data/tail_recursion.md)
    + [3.1.6. More List Syntax](data/more_list_syntax.md)
  - [3.2. Variants](data/variants.md)
  - [3.3. Unit Testing with OUnit](data/ounit.md)
    + [3.3.1. An Example of OUnit](data/ounit_example.md)
	+ [3.3.2. Explanation of the OUnit Example](data/ounit_explanation.md)
	+ [3.3.3. Improving OUnit Output](data/ounit_improved_output.md)
	+ [3.3.4. OUnit and Files](data/ounit_files.md)
    + [3.3.5. Test-driven Development](data/tdd.md)
  - [3.3. Records](data/records.md)
  - [3.4. Tuples](data/tuples.md)
  - [3.5. One-of vs. Each-of](data/oneof_eachof.md)
  - [3.6. Advanced Pattern Matching](data/pattern_matching_advanced.md)
    + [3.6.1. Pattern Matching with Let](data/pattern_matching_let.md)
	+ [3.6.2. Pattern Matching with Functions](data/pattern_matching_functions.md)
	+ [3.6.3. Pattern Matching Examples](data/pattern_matching_examples.md)
  - [3.7. Options](data/options.md)
  - [3.8. Association Lists](data/assoc_list.md)
  - [3.9. Type Synonyms](data/type_synonym.md)
  - [3.10. Algebraic Data Types](data/algebraic_data_types.md)
	- [3.10.1. Catch-all Cases](data/catch_all_cases.md)
	- [3.10.2. Recursive Variants](data/recursive_variants.md)
	- [3.10.3. Parameterized Variants](data/parameterized_variants.md)
	- [3.10.4. Polymorphic Variants](data/polymorphic_variants.md)
	- [3.10.5. Built-in Variants](data/builtin_variants.md)
  - [3.11. Exceptions](data/exceptions.md)
  - [3.12. Trees](data/trees.md)
  - [3.13. Natural Numbers](data/nats.md)
  - [3.14. Summary](data/summary.md)
  - [3.15. Exercises](data/exercises.md)
...
* [5. Modules](modules/intro.md)
  ...
  - [5.2. OCaml Modules](modules/structures.md)
	+ [5.2.1. Scope](modules/scope.md)
	+ [5.2.2. Signatures](modules/signatures.md)
    + [5.2.3. Abstract Types](modules/abstract_types.md)	
    + [5.2.4. Semantics of Modules](modules/semantics_modules.md)    
  - [5.3. Functional Data Structures](modules/functional_data_structures.md)
    + [5.3.1. Example: Stacks](modules/ex_stacks.md)
	+ [5.3.2. Example: Queues](modules/ex_queues.md)
	+ [5.3.3. Example: Dictionaries](modules/ex_dictionaries.md)
	+ [5.3.4. Example: Sets](modules/ex_sets.md)
	+ [5.3.5. Example: Arithmetic](modules/ex_arithmetic.md)
  - [5.4. Sharing Constraints](modules/sharing_constraints.md)
  - [5.5. Compilation Units](modules/compilation_units.md)
  - [5.6. Modules and the Toplevel](modules/toplevel.md)
  - [5.7. Includes](modules/includes.md)
	+ [5.7.1. Semantics of Includes](modules/semantics_includes.md)
	+ [5.7.2. Encapsulation and Includes](modules/encapsulation_includes.md)
	+ [5.7.3. Include vs. Open](modules/include_vs_open.md)
	+ [5.7.4. Including Code in Multiple Modules](modules/include_multiple.md)
  - [5.8. Functors](modules/functors.md)
	+ [5.8.1. Functor Syntax](modules/functor_syntax.md)
	+ [5.8.2. Using Functors](modules/using_functors.md)
	+ [5.8.3. Example: Standard Library Map](modules/stdlib_map.md)
  - [5.9. Summary](modules/summary.md)
  - [5.10. Exercises](modules/exercises.md)
...
- [9. Efficiency](eff/intro.md)
  ...
  - [9.3. Binary Search Trees](eff/bst.md)
  - [9.4. Red-Black Trees](eff/rb.md)  
...
* [11. Advanced Topics](adv/intro.md)
  - [11.1. Infinite Data Structures](adv/infinite.md)
	- [11.1.1. Streams](adv/streams.md)
	- [11.1.2. Programming with Streams](adv/stream_progs.md)
	- [11.1.3. Laziness](adv/lazy.md)
  - [11.2. Concurrency](adv/concurrency.md)
	- [11.2.1. Promises](adv/promises.md)
	- [11.2.3. Asynchronous I/O](adv/asynch_io.md)
	- [11.2.4. Callbacks](adv/callbacks.md)
	- [11.2.5. Implementing Callbacks](adv/implementing_callbacks.md)
  - [11.3. Monads](adv/monads.md)
	- [11.3.1. Example: The Maybe Monad](adv/ex_maybe_monad.md)
	- [11.3.2. Example: The Writer Monad](adv/ex_writer_monad.md)
	- [11.3.3. Example: The Lwt Monad](adv/ex_lwt_monad.md)
	- [11.3.4. Monad Laws](adv/monad_laws.md)
  - [11.4. Memoization](adv/memoization.md)
  - [11.5. Summary](adv/summary.md)
  - [11.6. Exercises](adv/exercises.md)  
