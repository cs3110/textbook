...
* [3. Data in OCaml](data/intro.md)
  ...
  - [3.4. Records](data/records.md)
  - [3.5. Tuples](data/tuples.md)
  - [3.6. One-of vs. Each-of](data/oneof_eachof.md)
  - [3.7. Advanced Pattern Matching](data/pattern_matching_advanced.md)
    + [3.7.1. Pattern Matching with Let](data/pattern_matching_let.md)
	+ [3.7.2. Pattern Matching with Functions](data/pattern_matching_functions.md)
	+ [3.7.3. Pattern Matching Examples](data/pattern_matching_examples.md)
  - [3.8. Options](data/options.md)
  - [3.9. Association Lists](data/assoc_list.md)
  - [3.10. Type Synonyms](data/type_synonym.md)
  - [3.11. Algebraic Data Types](data/algebraic_data_types.md)
	- [3.11.1. Catch-all Cases](data/catch_all_cases.md)
	- [3.11.2. Recursive Variants](data/recursive_variants.md)
	- [3.11.3. Parameterized Variants](data/parameterized_variants.md)
	- [3.11.4. Polymorphic Variants](data/polymorphic_variants.md)
	- [3.11.5. Built-in Variants](data/builtin_variants.md)
  - [3.12. Exceptions](data/exceptions.md)
  - [3.13. Trees](data/trees.md)
  - [3.14. Natural Numbers](data/nats.md)
  - [3.15. Summary](data/summary.md)
  - [3.16. Exercises](data/exercises.md)
